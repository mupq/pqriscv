...
static const uint32_t round_const_256[64] = {
...
static size_t crypto_hashblocks_sha256(uint8_t *statebytes,
    ...
    while (inlen >= 64) {
        const uint32_t* rconst = round_const_256;
...
static const uint64_t round_const_512[80] = {
...
static size_t crypto_hashblocks_sha512(uint8_t *statebytes,
    ...
    while (inlen >= 128) {
        const uint64_t* rconst = round_const_512;
